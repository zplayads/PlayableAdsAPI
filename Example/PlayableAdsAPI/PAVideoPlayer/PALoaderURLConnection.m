...
@interface PALoaderURLConnection ()<PAVideoRequestTaskDelegate>
...
@implementation PALoaderURLConnection
...
- (void)dealWithLoadingRequest:(AVAssetResourceLoadingRequest *)loadingRequest
{
    ...
    if (!self.task) {
        self.task = [[PAVideoRequestTask alloc] init];
...
#pragma mark - PAVideoRequestTaskDelegate
