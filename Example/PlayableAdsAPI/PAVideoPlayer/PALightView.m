...
@implementation PALightView

+ (instancetype)sharedInstance {
    static PALightView *instance;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        instance = [[PALightView alloc] init];
...
- (instancetype)init {
    if (self = [super init]) {
        ...
        self.backImage = ({
            ...
            imgView.image        = [UIImage imageNamed:PAImageSrcName(@"icon_brightness")];
